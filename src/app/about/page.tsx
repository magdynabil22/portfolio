      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          >
            ...
            <TypingEffect
              text="Software Engineer and Frontend Developer"
              speed={50}
              className={`${styles.textAlign} text-display-default-xs text-neutral-weak`}
            />
            {social.length > 0 && (
          ...
          {about.technical.display && (
            <>
              ...
              <Flex vertical="center" gap="8">
                {skill.icon && <Icon name={skill.icon} onBackground="neutral-weak" />}
